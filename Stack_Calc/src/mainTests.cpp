...
TEST(Operations, Comments) {
	const char* test_filename = "../tests/commets_test.txt";
...
TEST(Operations, PUSH) {
	const char* test_filename = "../tests/push_test.txt";
	//ofstream test_input;
...
TEST(Operations, POP) {
	const char* test_filename = "../tests/pop_test.txt";
	//ofstream test_input;
	//test_input.open(test_filename, fstream::out);
	//for (size_t i = 0; i < 1000000; i++) {
	//	test_input << "PUSH " << i << endl;
...
TEST(Operations, DEFINE) {
	...
	const char* test_filename = "../tests/define_test.txt";
	/*ofstream test_input;
	test_input.open(test_filename, fstream::out);
	for (size_t i = 0; i < 1000000; i++) {
...
TEST(Operations, PLUS) {
	...
	const char* test_filename = "../tests/plus_test.txt";
	ofstream test_input;
	test_input.open(test_filename, fstream::out);
...
TEST(Operations, MINUS) {
	...
	const char* test_filename = "../tests/minus_test.txt";
	ofstream test_input;
	test_input.open(test_filename, fstream::out);
...
TEST(Operations, MULTIPLICATION) {
	...
	const char* test_filename = "../tests/mult_test.txt";
	ofstream test_input;
	test_input.open(test_filename, fstream::out);
	for (size_t i = 0; i < 500000; i++) {
...
TEST(Operations, DIVISION) {
	...
	const char* test_filename = "../tests/div_test.txt";
	ofstream test_input;
	test_input.open(test_filename, fstream::out);
...
TEST(Operations, SQRT) {
	...
	const char* test_filename = "../tests/sqrt_test.txt";
	ofstream test_input;
	test_input.open(test_filename, fstream::out);
